...
const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "A robust automation tool that downloads media from the web. It utilizes a custom Python web scraper to parse HTML, locate hidden media streams, and extract video files from various sources automatically.",
      tags: ["Python", "Web Scraping", "Automation", "CLI"],
      link: "https://github.com/MarwanArafa/python-web-scraper",
    },
    {
      id: 3,
      title: "Tic-Tac-Toe Logic Engine",
      description: "A robust console-based implementation of the classic game. Built to demonstrate clean C++ logic, state management, and input validation. Serves as a foundational study in game loop architecture.",
      tags: ["C++", "Game Logic", "Console App"],
      link: "https://github.com/MarwanArafa/cpp-projects",
    },
  ],
};
